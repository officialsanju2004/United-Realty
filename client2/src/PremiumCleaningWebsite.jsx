...
const PremiumCleaningWebsite = () => {
  ...
  const galleryImages = [
    { id: 1, title: "Corporate Office Cleaning" },
    { id: 2, title: "Medical Facility Sanitation" },
    { id: 3, title: "Residential Deep Clean" },
    { id: 4, title: "Post-Construction Cleanup" },
    { id: 5, title: "Window Cleaning Services" },
    { id: 6, title: "Floor Maintenance" },
  ];
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'services', 'pricing', 'testimonials', 'gallery', 'faq', 'booking'];
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans antialiased">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#booking" className="text-gray-700 hover:text-emerald-600 font-medium transition-colors duration-300">Book Now</a>
            </div>
            
            <button className="bg-emerald-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-emerald-700 transition-colors duration-300 shadow-sm">
              Get Quote
            </button>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section id="hero" className="relative overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        ...
        <div className="container mx-auto px-6 py-24 relative z-10">
          <div className={`max-w-3xl transition-all duration-1000 ${isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-emerald-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div 
                key={service.id}
                className={`bg-white rounded-xl shadow-lg border border-gray-100 p-8 hover:shadow-xl hover:-translate-y-2 transition-all duration-500 ${
      ...
      <section id="testimonials" className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible.testimonials ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Hear from businesses and homeowners who trust us with their cleaning needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div 
                key={index}
                className={`bg-gray-50 rounded-xl p-8 transition-all duration-500 hover:shadow-lg ${
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {galleryImages.map((image, index) => (
              ...
              >
                <div className="h-64 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center group-hover:scale-110 transition-transform duration-700">
                ...
                <div className="absolute inset-0 bg-emerald-600/0 group-hover:bg-emerald-600/10 transition-all duration-500"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="bg-gray-950 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Office Cleaning</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Residential Cleaning</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Construction Cleanup</a></li>
                <li><a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors">Medical Sanitation</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>©  Growth Flow Media. All rights reserved.</p>
          </div>
        </div>
      </footer>
