      ...
      >
        <div className="flex items-center mb-6">
          <div className="relative">
            <div className="w-16 h-16 rounded-full bg-[#C99A2E] p-0.5">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-[#0a1628] shadow-lg py-3' : 'bg-[#0a1628]/95 py-5'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <div className="w-25 h-15 bg-[#C99A2E] rounded-lg flex items-center justify-center">
        ...
        <div className="container mx-auto px-6 relative z-10 mt-20">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-5 py-20">
              <button className="bg-[#C99A2E] text-[#0a1628] px-8 py-4 rounded-lg font-semibold hover:shadow-xl transition-all duration-300 hover:scale-105 text-lg">
                Explore Properties
              </button>
  ...
  <div className="container mx-auto px-6">
    <div className="bg-slate-50 rounded-[32px] p-8 lg:p-14">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <div className="flex gap-3 mb-6">
            ...
            <span className="bg-[#C99A2E] text-white px-4 py-2 rounded-full text-sm font-semibold">
              ★ 12+ YEARS
            </span>
          </div>
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-[#0a1628] leading-tight mb-6">
            ...
            <span className="text-yellow-500">With Nitish</span>
          </h2>

          <p className="text-gray-600 text-lg leading-relaxed mb-8">
            Helping families, investors and businesses discover premium
            residential and commercial properties with complete transparency,
            expert guidance and unmatched market knowledge.
          </p>

          <div className="flex gap-10 mb-10 flex-wrap">
            <div>
              <h3 className="text-4xl font-bold text-yellow-500">45+</h3>
              <p className="text-gray-500">Properties Sold</p>
            </div>

            <div>
              <h3 className="text-4xl font-bold text-yellow-500">₹200Cr+</h3>
              <p className="text-gray-500">Transaction Value</p>
            </div>
          ...
          <button className="bg-[#0a1628] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#C99A2E] hover:text-[#0a1628] transition">
            Learn More About Nitish
          </button>
        </div>
              ...
              <button
                ...
                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                  activeFilter === filter.key 
                    ? 'bg-[#C99A2E] text-[#0a1628] shadow-lg' 
            ...
            {filteredProperties.map((property) => (
              ...
              >
                <div className="relative overflow-hidden h-64">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#C99A2E] text-[#0a1628] px-3 py-1 rounded-full text-sm font-medium">
                    {property.tag}
                  </div>
                  <button 
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-[#0a1628] text-white py-3 rounded-lg font-medium hover:bg-[#C99A2E] transition-all duration-300 flex items-center justify-center group/btn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              ...
              <div className="p-8 md:p-10 bg-[#0a1628]">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-10 h-1 bg-[#C99A2E] rounded-full"></div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-[#C99A2E] rounded-full flex items-center justify-center mt-1 flex-shrink-0">
                ...
                <div className="flex flex-wrap gap-4">
                  <button className="bg-[#C99A2E] text-[#0a1628] px-6 py-3 rounded-lg font-semibold hover:bg-[#C99A2E] transition-all duration-300 flex items-center gap-2">
                    <Phone size={18} /> Schedule a Call
                  </button>
                  <button className="border border-yellow-400 text-yellow-400 px-6 py-3 rounded-lg font-semibold hover:bg-[#C99A2E]/10 transition-all duration-300 flex items-center gap-2">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 p-6 bg-[#0a1628] rounded-2xl shadow-lg">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <button className="px-6 py-3 bg-[#C99A2E] text-[#0a1628] font-semibold rounded-xl hover:bg-[#C99A2E] transition-colors duration-300 shadow-md hover:shadow-lg">
                Contact Support
              </button>
            </div>
          </div>
      ...
      <div id="contact-us" className="py-20 px-4 bg-white">
        ...
        >
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-2 bg-[#C99A2E] text-[#0a1628] text-sm font-semibold rounded-full mb-4 shadow-lg">
              📬 Get in Touch
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#C99A2E]/10 rounded-full -translate-y-16 translate-x-16 group-hover:scale-125 transition-transform duration-500"></div>
              <div className="absolute bottom-0 left-0 w-40 h-40 bg-[#C99A2E]/10 rounded-full translate-y-20 -translate-x-20 group-hover:scale-125 transition-transform duration-700"></div>
              
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-8">
                  <div className="p-3 bg-[#C99A2E] rounded-xl shadow-lg">
                ...
                <div className="space-y-8">
                  {[
                    ...
                    >
                      <div className="p-3 rounded-lg bg-[#C99A2E] shadow-lg text-[#0a1628]">
                        {item.icon}
                      </div>
            ...
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-[#C99A2E]"></div>
              ...
              <div className="relative z-10">
                ...
                <form className="space-y-6">
                  ...
                  >
                    <button
                      type="submit"
                      className="w-full bg-[#C99A2E] text-[#0a1628] font-bold py-4 px-6 rounded-xl shadow-lg hover:bg-[#C99A2E] transition-all duration-300 transform hover:-translate-y-1 text-lg"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              <div className="flex items-center space-x-2 mb-6">
                <div className="w-30 h-25 bg-[#C99A2E] rounded-lg flex items-center justify-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[<FaFacebook key="fb"/>, <FaInstagram key="ig"/>, <FaLinkedinIn key="in"/>, <FaTwitter key="tw"/>].map((social, idx) => (
                  <div 
                    key={idx}
                    className="w-10 h-10 bg-[#1a2a3a] rounded-full flex items-center justify-center hover:bg-[#C99A2E] hover:text-[#0a1628] cursor-pointer transition-colors duration-300 text-gray-400 hover:text-[#0a1628]"
                  >
                    {social}
                  </div>
                ))}
      ...
      <button className="fixed bottom-6 right-6 bg-[#C99A2E] text-[#0a1628] p-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 z-50">
        <Phone size={24} />
      </button>
    </div>
  );
